...
<div class="px-4 sm:px-6 lg:px-8 bg-white border-b border-gray-200 sticky top-32 sm:top-20 z-40 shadow-sm" style="top: 104px;">
    <div class="max-w-7xl mx-auto flex gap-1 sm:gap-8 overflow-x-auto scrollbar-hide justify-start sm:justify-center">
