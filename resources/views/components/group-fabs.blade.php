...
<div class="fixed bottom-6 right-6 sm:hidden z-40 flex flex-col gap-3">
    @if($showPdfExport)
    <!-- Export PDF FAB -->
    <a href="{{ route('groups.payments.export-pdf', $group) }}" class="inline-flex justify-center items-center w-14 h-14 bg-red-600 text-white rounded-full hover:bg-red-700 transition-all transform hover:scale-110 font-bold shadow-lg" title="Export Statement PDF">
