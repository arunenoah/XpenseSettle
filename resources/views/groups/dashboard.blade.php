        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center justify-between gap-3 sm:gap-4">
                ...
                <div class="hidden sm:flex gap-2 flex-shrink-0">
                    <a href="{{ route('groups.payments.export-pdf', $group) }}" class="px-3 py-1.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all font-semibold text-xs flex items-center gap-1" title="Export Statement PDF">
