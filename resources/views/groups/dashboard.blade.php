...
<div class="w-full bg-gradient-to-b from-blue-50 via-white to-white">
        ...
        <div class="max-w-7xl mx-auto space-y-8">
            ...
            <div class="grid grid-cols-3 gap-2 sm:gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-red-200 p-3 sm:p-6">
                    ...
                    <p class="text-lg sm:text-3xl font-bold text-red-600">{{ $group->currency }}{{ number_format($totalOwed, 2) }}</p>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-green-200 p-3 sm:p-6">
                    ...
                    <p class="text-lg sm:text-3xl font-bold text-green-600">{{ $group->currency }}{{ number_format($totalOwe, 2) }}</p>
    ...
    <!-- Settlement Summary - Compact mobile view -->
    @if(count($settlement) > 0)
        <div class="bg-gradient-to-br from-violet-50 via-purple-50 to-pink-50 rounded-xl shadow-lg p-3 sm:p-6">
            <h3 class="text-lg sm:text-2xl font-black text-gray-900 flex items-center gap-2 mb-3">
