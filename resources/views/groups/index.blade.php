                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-shadow h-full flex flex-col">
                        ...
                        <div class="flex items-start justify-between gap-3 mb-3">
                            <div class="flex items-start gap-3 flex-1 min-w-0">
                                @if($group->icon)
                                    <div class="text-3xl flex-shrink-0 mt-0.5">{{ $group->icon }}</div>
                                @endif
                            ...
                            <span class="inline-block px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-xs font-semibold whitespace-nowrap flex-shrink-0">
                                {{ $group->currency }}
                            </span>
                        </div>
